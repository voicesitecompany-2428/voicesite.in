        ...
        <div className="border-b border-gray-100 bg-white px-4 py-3 md:px-6">
            <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                    {/* Shop Credits */}
                    <div className="flex items-center gap-2.5 rounded-xl bg-[#f0f2f4] px-3 py-2 overflow-hidden">
                ...
                <div className="flex items-center justify-between gap-2 overflow-x-auto">
                    <div className="flex items-center gap-2 shrink-0">
                        {/* Store Expiry Badge */}
                        {sub.shop_limit > 0 && (
                            <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-xs font-medium whitespace-nowrap ${storeExpiring ? 'bg-red-50 border-red-100 text-red-600' : 'bg-green-50 border-green-100 text-green-700'}`}>
                                <span className="material-symbols-outlined text-[16px]">{storeExpiring ? 'history' : 'history'}</span>
                        ...
                        {sub.menu_limit > 0 && (
                            <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-xs font-medium whitespace-nowrap ${menuExpiring ? 'bg-red-50 border-red-100 text-red-600' : 'bg-blue-50 border-blue-100 text-blue-700'}`}>
                                <span className="material-symbols-outlined text-[16px]">{menuExpiring ? 'history' : 'history'}</span>
                    ...
                    <button
                        ...
                        className="text-xs font-semibold text-gray-600 hover:text-primary whitespace-nowrap px-2 py-1 rounded-md hover:bg-gray-50 transition-colors ml-auto"
                    >
                        Manage Plans
                    </button>
                </div>
