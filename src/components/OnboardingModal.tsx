            ...
            try {
                ...
                mediaRecorder.onstop = async () => {
                    ...
                    try {
                        ...
                        setStep(2); // Let them fill manually on error
                    } finally {
                        setIsProcessing(false);
                    }
                };
    ...
    */
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm transition-all duration-300">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-5 md:p-8 transform scale-100 opacity-100 transition-all duration-300 relative mx-4 max-h-[90vh] overflow-y-auto">
                ...
                {step === 0 && (
                    <div className="flex flex-col items-center text-center">
                        <h2 className="text-2xl md:text-3xl font-bold text-[#111418] mb-2">What would you like to build?</h2>
                        <p className="text-gray-500 mb-8">Choose the type of website you want to create.</p>
                ...
                {step === 1 && (
                    <div className="flex flex-col items-center text-center">
                        <button onClick={() => setStep(0)} className="absolute left-8 top-8 text-gray-500 hover:text-primary transition-colors flex items-center gap-1 text-sm font-medium">
                            <span className="material-symbols-outlined text-lg">arrow_back</span> Back
                        </button>

                        <h2 className="text-2xl md:text-3xl font-bold text-[#111418] mb-4">Tell us about your {siteType}</h2>
                        ...
                        <div className="bg-blue-50 rounded-xl p-4 mb-8 w-full max-w-lg border border-blue-100">
                            ...
                            <ul className="text-sm text-[#111418] grid grid-cols-2 gap-2 text-left">
                                <li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">check_circle</span> Name</li>
                                <li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">check_circle</span> Opening Timing</li>
                                <li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">check_circle</span> Contact Details</li>
                                <li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">check_circle</span> Location</li>
                            </ul>
                        </div>
                    ...
                    <div className="flex flex-col items-center w-full">
                        <div className="w-full flex items-center justify-between mb-6">
                            <button onClick={() => setStep(1)} className="text-gray-500 hover:text-primary transition-colors flex items-center gap-1 text-sm font-medium">
                                <span className="material-symbols-outlined text-lg">arrow_back</span> Re-record
                            </button>
                            <h2 className="text-xl md:text-2xl font-bold text-[#111418]">Review Details</h2>
                            <div className="w-16"></div>
                        </div>

                        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[50vh] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <div className="w-full mt-6 pt-6 border-t border-gray-100 flex justify-end">
                            <button onClick={() => setStep(3)} className="px-8 py-3 bg-primary hover:bg-blue-600 text-white font-bold rounded-lg shadow-md transition-colors flex items-center gap-2">
                                Save Changes <span className="material-symbols-outlined">check</span>
                            </button>
                        </div>
                    </div>
                )}
                ...
                {step === 3 && (
                    <div className="flex flex-col items-center w-full">
                        <div className="w-full flex items-center justify-between mb-6">
                            <button onClick={() => setStep(2)} className="text-gray-500 hover:text-primary transition-colors flex items-center gap-1 text-sm font-medium">
                                <span className="material-symbols-outlined text-lg">arrow_back</span> Back
                            </button>
                ...
                {step === 4 && (
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="w-full pt-6 border-t border-gray-100 flex justify-center gap-4">
                            <a href={`/shop/${generatedSlug}`} target="_blank" className="px-6 py-3 border border-primary text-primary font-bold rounded-full hover:bg-blue-50 transition-colors flex items-center gap-2">
